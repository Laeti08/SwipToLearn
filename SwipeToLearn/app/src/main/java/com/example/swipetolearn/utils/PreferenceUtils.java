package com.example.swipetolearn.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.example.swipetolearn.SwipeToLearnApplication;
...
public class PreferenceUtils {
	...
	private static SharedPreferences getSharedPreferences(){
		return SwipeToLearnApplication.getContext().getSharedPreferences(Constants.Preferences.SHARED_PREFERENCES_FILE_NAME, Context.MODE_PRIVATE);
	}
